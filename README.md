...
Содержит cервер документаций микросервисов.
...
| MONGODB_DATABASE                | Имя базы данных MongoDB.                                                   | docs                  |
| KAFKA_BOOTSTRAP_SERVERS         | Список URL для подключения к Apache Kafka.                                 |                       |
| KAFKA_CONSUMER_GROUP            | Имя группы потребителей в Apache Kafka.                                    | docs-server           |
